                    ...
                    <div className="uk-width-1-2@m">
                        <div className="uk-padding">
                            ...
                            <div className="actions uk-text-right@m">
                                <a href="https://www.projexino.com/" target="_blank" rel="noopener noreferrer"><i className="fas fa-external-link-alt"></i> Open</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="uk-width-1-2@m">
                        <div className="uk-padding">
                            ...
                            <div className="actions">
                                <a href="https://onlinetuition.mu/" target="_blank" rel="noopener noreferrer"><i className="fas fa-external-link-alt"></i> Open</a>
                            </div>
                        </div>
                    </div>
                ...
                <div className="project" data-uk-grid>
                    ...
                    <div className="uk-width-1-2@m">
                        <div className="uk-padding">
                            ...
                            <div className="actions uk-text-right@m">
                                <a href="https://www.universalsummits.com/" target="_blank" rel="noopener noreferrer"><i className="fas fa-external-link-alt"></i> Open</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="project" data-uk-grid>
                    ...
                    <div className="uk-width-1-2@m">
                        <div className="uk-padding">
                            ...
                            <div className="actions uk-text-right@m">
                                <a href="https://melodeeproduction.net/" target="_blank" rel="noopener noreferrer"><i className="fas fa-external-link-alt"></i> Open</a>
                            </div>
                        </div>
                    </div>
                </div>
